...
`CONF_FPM_LIMIT_FILES` | `CONF_FPM_LIMIT_FILES=40000` | 40000 | php-fpm, set open file descriptor rlimit for the master process. Default value: Set open file descriptor rlimit for the master process.
`CONF_FPM_LIMIT_CORE` | `CONF_FPM_LIMIT_CORE=unlimited` | unlimited | php-fpm, set max core size rlimit for the master process. Default value: 0.
